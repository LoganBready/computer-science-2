...
// 2) You are challenged to find the 4th element of the array, and you came up with this solution: let nfour = numbers[4]
...
// ANSWER: return (Math.sqrt(number))
...
// ANSWER: they are both dependant on the size of the string
...
class newCache {
  ...
  multiply(num1, num2) {
    ...
    if (this.cache.newNum) {
      return this.cache(newNum)
    }
    let answer = num1 * num2
    this.cache.newNum = answer
    return answer
  }
}
/*
...
// CODE HERE 
function noCacheMultiply (num1, num2) {
  let answer = num1 * num2
  return answer
}
/*
...
// ANSWER: The second one will be faster!

// Now fill this out and run your file

// CREATE A NEW INSTANCE OF YOUR CLASS

const newMultipler = new newCache

console.time("not memoized function time");
console.log(noCacheMultiply(1, 2))
console.log(noCacheMultiply(1, 2))
console.log(noCacheMultiply(1, 2))
console.log(noCacheMultiply(1, 2))
...
console.log(newMultipler.multiply(1, 2))
console.log(newMultipler.multiply(1, 2))
console.log(newMultipler.multiply(1, 2))
console.log(newMultipler.multiply(1, 2))
